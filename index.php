...
<body ng-app="myApp">
	<section id="index-sec" ng-controller="salesLoginController">
		<div class="main-container">
			...
			<div class="main-body">
				<div class="main-body-header text-center">
					<h5>Welcome to WAMP CRM</h3>
					<span style="color: #f00;" ng-if="isShow==true">Login Error</span>
				</div>
				<div class="form-body">
					<div class="form-header text-center">
						<h5>Login</h5>
					</div>
					<form  ng-submit="saleslogin()">
